		...
		<>
			<div className='banner'>
				<Container className='text-white'>
					...
					<Link
						to='/cakes'
						className='banner-btn text-decoration-none'
					>
						<span>Order Now</span>
					...
					<Row>
						<Col sm className='fac-con'>
							...
							>
								...
								adipisicing elit. Natus voluptatem at sint saepe
								id dolorem aut pariatur quas!
							</p>
						</Col>
						<Col sm className='fac-con'>
							<div className='img-container'>
						...
						<Col sm={5} className='pt-5'>
							<div className='mt-5 pl-3'>
								<h1 className='primary-color'>
									<span className='textprimary'>Our</span>{' '}
									Team
								</h1>
								<ul>
			...
			<Container>
				<h2
					id='#Contact'
					className=' h1 mx-auto py-3 text-center text-color font-weight-bolder'
				>
				...
				<Row className='mt-4 mb-4 pb-5'>
					...
					<Col sm={2} className='p-1'>
						<div
							className='mx-auto position-relative text-center'
							style={{ width: 'fit-content', top: '50%' }}
						>
							<span>-- or --</span>
						</div>
					</Col>
					...
					>
						<Container className='d-flex flex-column align-items-center justify-content-start pt-3 linktags'>
							<Link
								...
								className='align-self-center my-2 text-decoration-none text-reset'
							>
								<img
