...
function GetAllCakes({history}) {
  ...
  const responsive ={
    ...
    return (
        <div className="mt-2">
       <Container id='wrapper' className={`wrapper-cakes ${sideNav? 'toggled-complete':''}`} >
        ...
        <Dropdown >
           <Dropdown.Toggle  className="button-sidenav " id="dropdown-basic" style={{"width":"10rem!important"}}>
             {
             `${weight>=1000? weight/1000:weight} ${weight>=1000? "kg":"g"}`
             }
           </Dropdown.Toggle>
           <Dropdown.Menu>
        ...
        <h2 className="text-white pl-2" style={{"fontWeight":"600"}}>Reviews</h2>
          <Nav.Item className="d-flex align-items-center justify-content-center rating-item " onClick={()=>filterReviewHandler(4)}>
        ...
        <h4 className="text-white pl-2 ">&Up</h4>
          ...
          <Nav.Item className="d-flex align-items-center justify-content-center rating-item " onClick={()=>filterReviewHandler(3)}>
        <span style={{"color":"#ffdf00"}} class="fa fa-star"></span>
        <span style={{"color":"#ffdf00"}} class="fa fa-star"></span>
        <span style={{"color":"#ffdf00"}} class="fa fa-star"></span>
        <span class="fa fa-star text-white"></span>
        ...
        <h4 className="text-white pl-2 ">&Up</h4>
          ...
          <Nav.Item className="d-flex align-items-center justify-content-center rating-item " onClick={()=>filterReviewHandler(2)}>
        <span style={{"color":"#ffdf00"}} class="fa fa-star"></span>
        <span style={{"color":"#ffdf00"}} class="fa fa-star"></span>
        <span class="fa fa-star text-white"></span>
        <span class="fa fa-star text-white"></span>
        ...
        <h4 className="text-white pl-2 ">&Up</h4>
          ...
          <Nav.Item className="d-flex align-items-center justify-content-center rating-item " onClick={()=>filterReviewHandler(1)}>
        <span style={{"color":"#ffdf00"}} class="fa fa-star"></span>
        <span class="fa fa-star text-white"></span>
        <span class="fa fa-star text-white"></span>
        <span class="fa fa-star text-white"></span>
        ...
        <section id="content-wrapper" className="overflow-auto d-flex flex-column" style={{"height":"100vh"}}>
          <Carousel
           ...
           >
            ...
            <h4 className="mt-4 text-color">Available: <span className="text-primary font-weight-bold" >{dataprod.length}</span></h4>
        </section>
        </Container>
        </div>
    )
