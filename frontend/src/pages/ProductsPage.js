			...
			<aside id='sidebar-wrapper'>
				...
				<Nav className='d-flex align-items-center justify-content-around'>
					...
					<Dropdown>
						...
						<Dropdown.Menu>
							<Dropdown.Item onClick={() => filterWeight(500)}>
								500g
							</Dropdown.Item>
							<Dropdown.Item onClick={() => filterWeight(1000)}>
								1kg
							</Dropdown.Item>
							<Dropdown.Item onClick={() => filterWeight(1500)}>
								1.5kg
							</Dropdown.Item>
							<Dropdown.Item onClick={() => filterWeight(2000)}>
								2kg
							</Dropdown.Item>
						</Dropdown.Menu>
					</Dropdown>
